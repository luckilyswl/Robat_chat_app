package com.qingshangzuo.robatchatapp.utils;
...
import com.qingshangzuo.robatchatapp.result.Result;
...
public class HttpUtils {
    ...
    private static String setParmat(String message) {
        String url = "";
        try {
            url = ChatMessageAdapter.Config.URL_KEY + "?" + "key=" + ChatMessageAdapter.Config.APP_KEY + "&info="
